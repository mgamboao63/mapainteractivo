...
const overviewViews={
  ...
  2:{focusX:104,focusY:108,scale:1.22},
  3:{focusX:90,focusY:88,scale:1.55}
};
const routeScales={1:1.2,2:1.45,3:1.65};
...
function centerOnRoute(){if(!currentPath.length)return showAll();const nodes=FLOORS[currentFloor].graph.nodes,origin=nodes[currentPath[0]];focusX=origin.x;focusY=origin.y;targetX=105;targetY=225;rotation=90;baseScale=routeScales[currentFloor]||1.2;scale=1;panX=0;panY=0;applyTransform()}
